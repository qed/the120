...
import { CriterionDetail, type CriterionTaskItem } from "@/app/fp/components/journey/CriterionDetail";
import { loadJourney, resolveStudentSelf } from "@/app/fp/lib/journey-loader";
import { resolveCriterionNow, splitCriterionLabel } from "@/app/fp/lib/now-card-rules";

/**
 * /fp/criterion/[criterionId] — the landmark / criterion sheet (T1 Unit 14).
