...
import { resolveActorRole } from "@/app/fp/lib/access-rules";
import { evaluateTransition } from "@/app/fp/lib/path-rules";
import {
  criterionIdOf,
  interpretEcho,
  isTaskTransition,
...
} from "@/app/fp/lib/progress-core";
import {
  loadCriterionSnapshot,
  loadStudentContext,
  moveTask,
  type StudentContext,
} from "@/app/fp/lib/progress-loader";
import { notifyAfterTransition } from "@/app/fp/lib/notify/send";
import { evidenceFingerprint } from "@/app/fp/lib/evidence-rules";
import type { CriterionSnapshot, TransitionCtx } from "@/app/fp/lib/transition-table";
