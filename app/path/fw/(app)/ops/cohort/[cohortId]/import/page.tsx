...
import FwImport from "@/app/path/fw/components/FwImport";
import { isFwStaffActor } from "@/app/path/lib/fw-access-rules";
import { resolveFwActorForCohort } from "@/app/path/lib/fw-auth";
import { loadFwOpsCohort } from "@/app/path/lib/fw-ops-core";

/**
 * /path/fw/ops/cohort/[cohortId]/import — bulk roster import (FW Unit 7).
 *
