 ...
 * warning. Mounted ONCE from `app/path/fw/(app)/layout.tsx` — the guide subtree —
 ...
 *   - `/sw.js` from the origin root, scope `/path/fw` (the shared worker, narrowed),
 *     `updateViaCache: "none"`.
...
import { FwQueuedIndicator } from "@/app/path/fw/components/FwQueuedIndicator";
import {
  dismissFwEntry,
  isFwAuthRequired,
  isFwQueueSupported,
...
import { shouldRegisterServiceWorker } from "@/app/path/lib/sync-rules";
