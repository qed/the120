...
const FORMS = [
  {
    name: "FwQuickCreate",
    relative: "../../../fp/fw/components/FwQuickCreate.tsx",
    handlerAnchor: "const handleSubmit",
  },
  {
    name: "FwSignInForm",
    relative: "../../../fp/fw/(auth)/sign-in/FwSignInForm.tsx",
    handlerAnchor: "const handleSubmit",
  },
  {
    name: "ClaimGuideInviteForm",
    relative: "../../../fp/fw/(auth)/invite/[token]/ClaimGuideInviteForm.tsx",
    handlerAnchor: "const handleSubmit",
  },
] as const;
...
describe("a late-resolving quick-create never lands state on a dead component", () => {
  it("FwQuickCreate: both failure arms of handleSubmit sit behind the mounted-ref guard", () => {
    ...
    const code = stripComments(read("../../../fp/fw/components/FwQuickCreate.tsx"));
