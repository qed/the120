...
import PROGRAM from "@/app/fp/content/generated/program-2026-27";
import {
  LOG_TEMPLATES,
  columnsForBand,
  logTemplateFor,
} from "@/app/fp/content/log-templates";
import {
  SAFETY_COPY,
  SAFETY_FLAGS,
  ...
  flaggedTaskIds,
  safetyFlagsFor,
} from "@/app/fp/content/safety-flags";
import {
  EVIDENCE_SPECS,
  evidenceSpecFor,
} from "@/app/fp/content/evidence-spec";
