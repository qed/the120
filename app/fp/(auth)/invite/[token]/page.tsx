...
import { inviteVerdict } from "@/app/fp/lib/onboarding-rules";
import AcceptInviteForm from "./AcceptInviteForm";

/**
 * /fp/invite/[token] — the co-parent invite landing (T1 Unit 15). Unguarded
...
export const metadata: Metadata = {
  title: "Family invite — First Profit",
        ...
        {!verdict.ok ? (
          ...
          <>
            <p className="mt-2 font-path-body text-sm leading-6 text-hq-ink-soft">
              You&apos;ve been invited to join your family on First Profit as a parent — you review and
