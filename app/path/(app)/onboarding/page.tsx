...
import { loadLinkableFounders, resolveParentFamily } from "@/app/path/lib/family-loader";
import { resolveOnboardingMode } from "@/app/path/lib/onboarding-rules";
import { AddFounder } from "@/app/path/components/AddFounder";

/**
 * /path/onboarding — add a founder (T1 Unit 15; handoff scene 2). The
