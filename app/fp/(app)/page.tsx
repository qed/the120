...
import { HQDashboard } from "@/app/fp/components/journey/HQDashboard";
import { TrailTerritoryMap } from "@/app/fp/components/journey/TrailTerritoryMap";
import { buildJourneyView, loadJourney, resolveStudentSelf } from "@/app/fp/lib/journey-loader";
...
export default async function PathJourneyPage() {
  ...
  if (!self) {
    ...
    if (isParent) redirect("/fp/family");
    return (
