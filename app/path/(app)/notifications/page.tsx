...
import { Icon, type IconName } from "@/app/path/components/system/Icon";
import { cn } from "@/app/path/components/system/cn";
import { MarkSeenOnMount } from "./MarkSeenOnMount";

/**
 * /path/notifications — the R27 in-app surface (T1 Unit 16): the guaranteed
 ...
 * queue); any other non-student session is a 404 (mirrors /path/review).
 */

export const metadata: Metadata = {
  title: "Notifications — The Path",
