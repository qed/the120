  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-hq-canvas px-6 py-12 font-path-body">
      <div className="w-full max-w-md rounded-2xl border border-hq-border bg-hq-surface p-8 shadow-hq">
        <p className="font-path-mono text-[11px] uppercase tracking-[0.14em] text-hq-ink-muted">First Profit</p>
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <a href="/fp" className="text-sm text-hq-ink-soft underline underline-offset-2">
            Back to First Profit
          </a>
        </div>
      </div>
    </main>
