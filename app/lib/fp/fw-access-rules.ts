 ...
 * `app/lib/fp/access-rules.ts` and `app/crm/lib/access.ts`: the decision table
...
/**
 * Guide invites live FOURTEEN days — their own constant. (The retired
 * co-parent invite used seven; that feature and its rules were removed in v3
 * plan Unit 10, and this one is a DIFFERENT concept that merely shares the
 * word.)
 *
...
/**
 * The claim-page decision for guide credentials.
 *
 * Order matters: existence, then single-use, then
 ...
 *
 * Deliberately WITHOUT any session-email match. A guide invite
