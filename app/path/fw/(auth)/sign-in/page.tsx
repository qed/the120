...
/**
 * /path/fw/sign-in — the GUIDE door (FW Unit 2).
 *
 * A separate door from /path/sign-in, and the proxy's `fw-login` outcome exists
 ...
 * /path/fw besides the invite and board token subtrees.
 *
