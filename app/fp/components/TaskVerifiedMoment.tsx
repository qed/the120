 ...
 * /fp/notifications the host stays quiet entirely: the feed page IS the
...
import { markNotificationEventsSeen } from "@/app/fp/lib/actions/notifications";
import {
  MAX_SEEN_IDS_PER_CALL,
  MOMENT_DISPLAY_MS,
  MOMENT_GAP_MS,
  type Moment,
} from "@/app/fp/lib/celebration-tier1-rules";
...
export function TaskVerifiedMoment({
  ...
  const onFeedPage = pathname.startsWith("/fp/notifications");
