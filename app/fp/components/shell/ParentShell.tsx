...
import { skinClass } from "@/app/fp/lib/skin-tokens";
...
const NAV = [
  ...
  { href: "/fp/review", label: "Review Queue" },
  { href: "/fp/family", label: "Family" },
  { href: "/fp/onboarding", label: "Add a founder" },
];
      ...
      <div className={cn("min-h-screen lg:flex", canvas)}>
        ...
        <div className="flex min-h-screen min-w-0 flex-1 flex-col">
          ...
          >
            ...
            <div className="flex items-center gap-2.5">
              <nav className="flex items-center gap-2" aria-label="First Profit">
                {NAV.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
