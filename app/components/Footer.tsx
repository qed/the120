      ...
      <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-7">
        ...
        <div className="border-t border-white/25 pt-5">
          <span className="text-xs leading-relaxed text-white/70">
            © 2026 The 120 · A learning centre, part of the 2 Hour Learning Network. Official
            licensed partner of GT School. Not an accredited school. TIN CAN is a trademark of
