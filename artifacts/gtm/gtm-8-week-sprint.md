...
- **Structure:** **two age cohorts (8–13 and 14–17)**; the program arc is **The Path — Sell → Build → Validate → Grow → Scale** (5 criteria per phase).
