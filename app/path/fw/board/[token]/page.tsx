...
import { loadFwBoardShell, resolveFwBoardToken } from "@/app/path/lib/fw-board-loader";
import FwBoard from "@/app/path/fw/components/board/FwBoard";

/**
 * /path/fw/board/[token] — the projected cohort board (FW Unit 6).
 *
