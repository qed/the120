...
import { TaskSurface } from "@/app/path/components/task/TaskSurface";
import { loadTaskDetail, resolveStudentSelf } from "@/app/path/lib/journey-loader";
import { pinCookieName, sanitizePinnedTaskId } from "@/app/path/lib/now-card-rules";

/**
 * /path/task/[taskId] — the capture and submit surface (T1 Unit 14). The first
