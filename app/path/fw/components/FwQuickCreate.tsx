...
import { lookupFwStudentMatch, quickCreateFwStudent } from "@/app/path/lib/actions/fw-student";
import type { FwMatchVerdict } from "@/app/path/lib/fw-match-rules";
import { FW_BAND_LABEL } from "@/app/path/lib/fw-nav-rules";
import type { FwQuickCreateActionResult } from "@/app/path/lib/fw-student-core";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push(`/path/fw/cohort/${cohortId}/student/${res.studentId}`);
        router.refresh();
