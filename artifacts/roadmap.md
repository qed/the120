...
**GTM-4 · Ambassador reporting** *(dev)* — 🟡 **Built 2026-07-15; ⛔ one activation step: apply the `ambassador_codes` migration** (via Management API — stored DB password is stale, see E5; the report degrades gracefully until then). **Needed by W2 (Jul 20).**
