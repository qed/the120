 ...
 * writes `app/lib/fp/content/generated/program-<version>.ts`.
 *
...
import { parseCurriculum } from "../app/lib/fp/content/parse-curriculum";
import { assertMatchesManifest, manifestFor } from "../app/lib/fp/content/manifest";
...
const OUT_DIR = path.resolve(process.cwd(), "app/lib/fp/content/generated");
