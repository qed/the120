...
import FwReadingRule from "@/app/path/fw/components/FwReadingRule";
import FwTaskTree from "@/app/path/fw/components/FwTaskTree";
import { resolveFwActorForCohort } from "@/app/path/lib/fw-auth";
import { loadFwStudentDrilldown } from "@/app/path/lib/fw-loader";
import { buildFwTaskTree, FW_BAND_LABEL, summarizeFwResume } from "@/app/path/lib/fw-nav-rules";

/**
 * /path/fw/cohort/[cohortId]/student/[studentId] — one student's whole catalog
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-5 py-6">
      ...
      <div className="mt-4">
        <FwTaskTree
          phases={phases}
          taskHrefPrefix={`/path/fw/cohort/${cohortId}/student/${studentId}/task`}
        />
      </div>
    </main>
  );
