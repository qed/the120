...
**S10 · Stripe go-live** *(Owner: Peter + dev)* — 🟡 **Live-mode audit done 2026-07-14: descriptor ✅, but no live product/price/webhook exist and production still runs test keys. Blocked on Peter for keys; ~15 min of manual steps remain. Required before accepting real deposits — and now also gates the CRM send-offer-email feature (see `docs/brainstorms/2026-07-14-dossier-status-mover-and-offer-email-requirements.md`).**
